package com.fsrspring.vocab.progressanalytics.controller;
...
import com.fsrspring.vocab.progressanalytics.service.ProgressService;
...
@RestController
@RequestMapping("/api/progress-analytics/progress")
...
public class ProgressController {
    ...
    public ResponseEntity<Map<String, Object>> getStats() {
        ...
        return ResponseEntity.ok(Map.of(
                ...
                "dueNow", reviewSchedulingService.getFsrsStats().get("dueNow"),
